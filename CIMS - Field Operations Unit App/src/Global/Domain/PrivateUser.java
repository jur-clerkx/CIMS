...
@Entity
@NamedQueries({
    @NamedQuery(name = "PrivateUser.getAllPrivateUsers", query = "SELECT u FROM PrivateUser AS u"),
    @NamedQuery(name = "PrivateUser.getAllBySector", query = "SELECT u FROM PrivateUser AS u WHERE u.sector = :sectorName")
})
